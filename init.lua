...
-- Add to your init.lua or equivalent config file
...
vim.keymap.set('n', '<left>', '<cmd>echo "Use h to move bitch!!"<CR>')
vim.keymap.set('n', '<right>', '<cmd>echo "Use l to move bitch!!"<CR>')
vim.keymap.set('n', '<up>', '<cmd>echo "Use k to move bitch!!"<CR>')
vim.keymap.set('n', '<down>', '<cmd>echo "Use j to move bitch!!"<CR>')
...

  {
    ...
    { 'Bilal2453/luvit-meta', lazy = true },
    {
      ...
      config = function()
        ...
        -- Set tab-related settings for TSX files (and other related file types)
        vim.api.nvim_create_autocmd('FileType', {
          pattern = { 'typescript', 'typescriptreact', 'javascript', 'javascriptreact' },
          callback = function()
            vim.bo.expandtab = true -- Use spaces instead of tabs
            vim.bo.shiftwidth = 1 -- Number of spaces per indentation level
            vim.bo.softtabstop = 1 -- Number of spaces for a tab
            vim.bo.tabstop = 1 -- Number of spaces for a hard tab
          end,
        })
            ...
            settings = {
              Lua = {
                ...
                workspace = {
                  ...
                  checkThirdParty = false, -- Optional, disables annoying popups
                },
                telemetry = {
        ...
        -- Ensure all necessary LSP servers are installed via mason-lspconfig
        require('mason-lspconfig').setup {
          ensure_installed = vim.tbl_keys(servers),
        }

        -- Configure mason-lspconfig to set up each server
        ...
        -- Ensure formatting and linting tools are installed via mason-tool-installer
        require('mason-tool-installer').setup {
          ensure_installed = {
            'typescript-language-server',
            'pyright', -- Pyright can also be considered as a tool for Python LSP
            'lua-language-server',
            'eslint_d',
            'flake8',
            'prettier',
          ...
          start_delay = 3000, -- Delay in ms before starting installer
        }
      end,
    },
    ...
    -- Optional: Add any additional plugins or configurations below
  },
