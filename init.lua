...
require('lazy').setup({
...

  {
    ...
    },
    {
      ...
      config = function()
        -- ... (The first part of your config function remains the same, up to the 'servers' definition)
        -- ... (from "Brief aside: **What is LSP?**" down to the end of the 'servers' table)
        ...
        vim.api.nvim_create_autocmd('LspAttach', {
          ...
          callback = function(event)
            ...
            map('<leader>k', vim.lsp.buf.hover, 'Hover Documentation') -- Show documentation for what is under the cursor
